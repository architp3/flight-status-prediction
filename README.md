...
# Dataset
The dataset used for our prediction model (Combined_Flights_2022.csv) is a collection of flights from the year 2022. Using this dataset, we hope to predict if flights will be canceled or not.
